...
func NewXACacheFromEnvironment() (*XACache, error) {
	...
	cache := &XACache{
		...
		workerCount:             envPositiveInt("XA_CACHE_STUDY_WORKERS", 1),
		frameWorkers:            envPositiveInt("XA_CACHE_FRAME_WORKERS", 1),
		...
		archiveSlots:            make(chan struct{}, envPositiveInt("XA_ARCHIVE_STUDY_WORKERS", 1)),
